...
Datetime PickStart5(Datetime previous_start, Datetime previous_end, 
  ...
  Datetime s_e, s_a, previous_workday_end, temp_date_time;
  double   rest_time, n_a, m_a, p_a, n_e, m_e, p_e, advantage_index;
  
  previous_workday_end = DateTimeAt1900(previous_start);
    
  rest_time = std::max(0.0, (previous_end - previous_workday_end)/60/60);
  s_e       = CalculateDateTimeAfterResting(previous_end, rest_time);
